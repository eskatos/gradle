...
public class DefaultBuildTreeFinishExecutor implements BuildTreeFinishExecutor {
    ...
    public RuntimeException finishBuildTree(List<Throwable> failures) {
        ...
        List<Throwable> finishFailures = new ArrayList<>(finishResult.getFailures());
        ...
        ExecutionResult<Void> finalResult = ExecutionResult.maybeFailed(reportableFailure).withFailures(ExecutionResult.maybeFailed(finishFailures));
        return finalResult.getFailureOrNull();
    }
}
